...
// ---------------------------------------------------------------heartRate Draw
// async function heartRateDraw() {
//   // Data
//   const dataset = await d3.csv("HR_measurement.csv");
//   console.log(dataset[0])
//   // converting time and string
//   const parseDate = d3.timeParse("%Y-%m-%d");
//   const formatDay = d3.timeFormat("%a"); // Format: "Mon"
//   const formatDate = d3.timeFormat("%d"); // Format: "11"
//   const xAccessor = (d) => parseDate(d.Subject);
//   const yAccessor = (d) => parseInt(d.Measurement_Number);
...
//       tooltip.select(".price3").text(`$${yAccessor(stock)}`);
...
async function draw3() {
  ...
  console.log(dataset,"222")
  // Convert time and string
  const parseDate = d3.timeParse("%Y-%m-%d");
  const formatDay = d3.timeFormat("%a"); // Format: "Mon"
  const formatDate = d3.timeFormat("%d"); // Format: "11"
  const xAccessor = (d) => parseInt(d.Measurement_Number)
  const yAccessor = (d) => parseInt(d.HR_Fingertip_Pulse_Oximeter)
